      ...
      valueProps: [
        {
          ...
          description: "Clear distinction between UX layer and regulated financial rails"
        },
        {
          title: "Routing Intelligence",
          description: "Smart order routing to optimize for speed, cost, and availability"
        },
        {
          title: "Compliance-First Design",
          description: "Built from the ground up with regulatory alignment in mind"
        },
        {
          title: "Developer Experience",
          description: "APIs and integrations designed for enterprise-grade deployment"
        }
      ]
    }
  },
      ...
      userSegments: [
        {
          ...
          description: "Retail crypto buyers and sellers seeking compliant EUR on/off-ramp"
        },
        {
          segment: "Crypto Businesses",
          description: "Platforms requiring embedded fiat-crypto conversion"
        },
        {
          segment: "Developers & Integrators",
          description: "Teams building fintech applications with crypto components"
        }
      ],
      useCases: [
  ...
  },
  {
    ...
    content: {
      layers: [
        ...
        {
          name: "Routing Layer",
          components: ["Smart Order Router", "Rate Aggregation", "Provider Selection"]
        },
        {
          name: "Integration Layer",
          components: ["Partner APIs", "Webhook Events", "Status Tracking"]
        },
        {
          name: "Provider Layer",
