...
Usage:
    ...
    API_URL=https://ramp-platform-1.preview.emergentagent.com/api python scripts/e2e_test.py
...
BASE_URL = os.environ.get('API_URL', 'https://ramp-platform-1.preview.emergentagent.com/api')
